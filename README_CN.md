...
<table>
  ...
  <tr>
    <td width="50%" align="center" valign="top">
      ...
      <br />
      <sub><strong>卡片组</strong> · 按主题管理卡片并支持跨组移动</sub>
    </td>
    <td width="50%" align="center" valign="top">
...
**2. 公开落地页 + 登录后工作台双入口**
`/` 是可公开展示的中英文 landing page，`/app` 是登录后的真实学习工作台。既方便对外展示，也保证业务链路聚焦在认证后执行。
...
- **先选组再保存** — 保存前手动选择目标卡片组，后续可在卡片组管理中再调整
...
- **公开页双语切换** — landing page 支持中文 / 英文切换，便于对外展示作品
...
- [ ] 重新评估 Group Agent 可用性，仅在明显优于手动选组时保留
