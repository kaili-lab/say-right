...
| UI-010 | 组内卡片编辑/移动/删除交互 | todo | UI-009 | API-006, API-007 | `docs/contracts/v0.3-card-management.yaml` | SP-007 |
| UI-011 | 登录注册页与头像下拉菜单 | todo | UI-003 | API-004 | `docs/contracts/v0.1-auth-basic.yaml` | SP-002 |
